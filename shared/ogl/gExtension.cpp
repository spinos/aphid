...
char gExtensionInit()
{
	...
	GET_EXT_POINTER(glMultiTexCoord4fv, PFNGLMULTITEXCOORD4FVPROC);
	...
	GET_EXT_POINTER(glUniform3fvARB, PFNGLUNIFORM3FVARBPROC);
...
GET_EXT_POINTER(glUniform3fv, PFNGLUNIFORM3FVPROC);
