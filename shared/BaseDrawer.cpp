...
void BaseDrawer::initializeProfile()
{
	...
	paintMat = new GMaterial(Color4(0.0, 0.0, 0.0, 1.0),
							Color4(0.8, 0.8, 0.8, 1.0),
							Color4(0.8, 0.8, 0.0, 1.0),
							Color4(0.0, 0.0, 0.0, 1.0),
							Color4(0.0, 0.0, 0.0, 1.0), 
							100.f);
	...
	fillLit.m_Ambient = Color4(0.1f, 0.1f, 0.1f, 1.f);
	fillLit.m_Diffuse = Color4(0.2f, 0.2f, 0.2f, 1.f);
