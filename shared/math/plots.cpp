...
void UniformPlot1D::linspacex(const int & n)
{
	float h = 1.f / (n-1);
	for(int i=0;i<n;++i)
		m_xvar[i] = h * i;
...
float * UniformPlot1D::x()
{ return m_xvar.v(); }

const float * UniformPlot1D::x() const
{ return m_xvar.v(); }
...
const UniformPlot1D::GeomType & UniformPlot1D::geomType() const
{ return m_gt; }

void UniformPlot1D::setGeomType(GeomType t)
{ m_gt = t; }

void UniformPlot1D::setMarkStyle(MarkStyle t)
{ m_mstyle = t; }

const UniformPlot1D::MarkStyle & UniformPlot1D::markStyle() const
{ return m_mstyle; }
