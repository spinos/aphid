...
int main(int argc, char *argv[])
{
	...
	FILE *fin = fopen("/Users/jianzhang/aphid/pyqt_in_qwidget/foo.py","r+");
	PyRun_SimpleFile(fin,"foo");
		...
		PyObject *clausInstance = PyObject_CallObject(claus, NULL); 
		
		int wnd = wig->winId();
		cout<<"winid "<<wnd<<endl;
		PyObject* snakewig = Py_BuildValue("i", wnd);
		
		PyObject_CallMethodObjArgs(clausInstance, PyString_FromString("setupUi"), snakewig, NULL);
